...
export const ReviewListPage = () => {
    ...
    const indexOfLastReviews: number = currentPage * reviewsPerPage;
    const indexOfTotalReviews: number = indexOfLastReviews - reviewsPerPage;
    ...
    return (
        <div className="container m-5">
            ...
            <p>
                {indexOfTotalReviews + 1} to {lastItem} of {totalAmountOfReviews} items:
            </p>
            <div className="row">
                {reviews.map(review => (
