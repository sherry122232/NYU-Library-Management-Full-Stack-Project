...
export const LeaveAReview: React.FC<{submitReview: any}> = (props) => {
    ...
    function starValue(value: number){
        setStartInput(value);
        setDisplayInput(true); // if user click on the star, it is true
    }
    ...
    return (
        <div className="dropdown" style={{ cursor: 'pointer'}}>
            ...
            <form method="POST" action="#">
                ...
                <div>
                    <button type="button" onClick={()=> props.submitReview(startInput,reviewDescription)} className="btn btn-primary mt-3" >
                        Submit Review
